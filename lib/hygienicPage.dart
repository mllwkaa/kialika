...
class HygienicPage extends StatefulWidget {
  @override
  _HygienicPageState createState() => _HygienicPageState();
}

class _HygienicPageState extends State<HygienicPage> {
  List<Map<String, dynamic>> products = [
    {
      'name': 'Marvis Sensitive Gums Gentle Mint Toothpaste (75ml)',
      'price': 20,
      'discountPrice': 15,
      'rating': 4.5,
      'sales': 95,
      'image': 'assets/Hygienic/marvis.jpg',
    },
    {
      ...
      'rating': 4.8,
      'sales': 150,
      'image': 'assets/Hygienic/cerave.jpg',
    },
  ];
